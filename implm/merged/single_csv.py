...
from src.reader.merged.columns import MergedCol
from src.reader.merged.split_frame import MergedSplitFrames
...
class SingleCsv:
    ...
    _frames:MergedSplitFrames | None = None
    ...
    def get_frames(
        ...
        base:MergedFrame = MergedFrame.get_merged_frame(
            base_csv_path=base_csv_path, 
            rpm_csv_path=rpm_csv_path, 
        ...
        return MergedSplitFrames(entries)

    
    def plot_cpu_percentage(self, img_path:str):
        y_series_list = self._frames.get_series(MergedCol.CPU_PERCENTAGE)
